...
class VC0706:
    ...
    def __init__(self, baud: Literal[9600, 19200, 38400, 57600, 115200], buffer_size: int = 100) -> None:
    ...
    def baudrate(self, baud: Literal[9600, 19200, 38400, 57600, 115200]) -> None:
        ...
        self._uart = UART(1, baudrate=baud)
